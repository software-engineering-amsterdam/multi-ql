...
public class DuplicateIdentifierSameType extends Warning {
	...
	public String getMessage() {
		return MessageFormat.format(DuplicateIdentifierSameType.MESSAGE, identifier.getValue(), identifier.getLocation());
	}
