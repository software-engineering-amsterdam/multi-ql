/**@goal of the Subclass search and visit the GreaterEqual (>=)
...
public class GreaterEqual extends BinSearchTree {
						
	public GreaterEqual (AbsExpression leftExp, AbsExpression rightExp) {
