...
/**@goal of the Subclass search and visit the LessThan(<)
...
public class LessThan extends BinSearchTree {
						
	public LessThan (AbsExpression leftExp, AbsExpression rightExp) {
