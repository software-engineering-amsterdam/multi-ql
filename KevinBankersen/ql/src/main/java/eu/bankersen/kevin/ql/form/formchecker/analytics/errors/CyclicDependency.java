...
public class CyclicDependency extends AnalyticsError {
	...
	public CyclicDependency(int line, Set<String> variables, Set<String> dependencySet) {
		super(line, String.format("The expression \"if(%s)\" has a cyclic dependency with its own block %s!", variables,
				dependencySet));
	}

	public CyclicDependency(int line, Set<String> identifier, Set<String> ifBlock, Set<String> elseBlock) {
		super(line,
