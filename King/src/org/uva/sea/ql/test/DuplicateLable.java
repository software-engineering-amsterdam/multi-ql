...
public class DuplicateLable {

	@Test
	public void test() throws IOException {
		ANTLRInputStream input = new ANTLRFileStream(new File("resources/test/questionairetestduplicatelable.gr").getPath());
