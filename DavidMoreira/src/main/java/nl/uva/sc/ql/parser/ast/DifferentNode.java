...
public class DifferentNode extends BinaryExpressionNode {

	public DifferentNode(ExpressionNode left, ExpressionNode right){
		super(left, right);
	}
	...
	public Value eval(State state) {
		...
		if (valueLeft != null && valueRight != null){
			return ((BooleanVal) valueLeft).different((BooleanVal) valueRight);
		}
